...
struct parport_ip32_private {
	...
	int irq_mode;
#define PARPORT_IP32_IRQ_FWD	0 /* forward interrupt to parport layer */
#define PARPORT_IP32_IRQ_OWN	1 /* own irq handling */
					     ...
					     int flags, byte mode)
{
	...
	priv->irq_mode = PARPORT_IP32_IRQ_OWN;
